...
if __name__=='__main__':
    ...
    k_path='code/part_2/data_for_part2/H.txt'
    ...
    for file_name in os.listdir(input_dir):
        if file_name.endswith('.txt'):
            ...
            with open(file_path, 'r') as f:
                lines = f.readlines()
            header_lines = [line.replace('Angstrom','μm').replace('ANGSTROM','μm') for line in lines if line.startswith('#')]
            ...
            # 保存结果
            output_path_dir = 'models/bt-settle_H'
