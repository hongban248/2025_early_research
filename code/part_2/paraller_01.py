...
lib_path='code/c/func_export.so'
# 2. 加载
...
if __name__=='__main__':
    H_path='datas/H_BC.txt'
    K_path='datas/K_BC.txt'
    ...
    #最终结果保存路径
    excel_path='outcomes/ck_gk_vr_vsini_modified.xlsx'
    #创建excel文件，并添加表头
    data = ["number","file name", "teff", "logg","meta","alpha","vr","vsini","Ck","Gk"]  # 要添加的行数据
    create_excel_and_add_row(excel_path, data)
    number=1

    input_dir = '/mnt/remote/myresource/2023早期科研/models/bt-settle' # 替换为你的文件夹路径
