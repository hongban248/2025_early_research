...
if __name__ == '__main__':
    ...
    obv_path1='code/part_2/outcome_for_part2/SDCH_20240203_0071_middle.back1/outcome.csv'
    ...
    k_path='code/part_2/outcome_for_part2/SDCK_20240203_0071_middle.back1/outcome.csv'
    ...
    np.savetxt('code/part_2/data_for_part2/H.txt', np.c_[wavelength_H, flux_H*2.263531431854036e-19, error_H*2.263531431854036e-19], 
                   header='# wavelength(micron) flux(erg/s/cm2/micron) error(erg/s/cm2/micron)')

    np.savetxt('code/part_2/data_for_part2/K.txt', np.c_[wavelength_K, flux_K*2.582936069355631e-19, error_K*2.582936069355631e-19], 
                   header='# wavelength(micron) flux(erg/s/cm2/micron) error(erg/s/cm2/micron)')