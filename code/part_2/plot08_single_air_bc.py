...
def get_txt(file_path):
    try:
        ...
        e=flux
        return wavelength[find_insert_position(wavelength,0.8):find_insert_position(wavelength,2.6)],flux[find_insert_position(wavelength,0.8):find_insert_position(wavelength,2.6)],e[find_insert_position(wavelength,0.8):find_insert_position(wavelength,2.6)]
...
if __name__ == "__main__":
    ...
    #print(wavelength_model[-1])

    #对模型数据进行vsini和vr处理(第二，三重循环)
    # vr=0
    # vsini=0
    ...
    # #print(wavelength_model_vr[-1],wavelength_K[-1])
    ...
    ck,gk=get_ck_gk(vr=0,vsini=10,
                    ...
                    save_model_vr_vsini_H=True,save_model_vr_vsini_K=True,original_model_name=model_path)