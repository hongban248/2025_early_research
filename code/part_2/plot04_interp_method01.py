...
本代码是方1，先求加权平均，再插值，结果存储在文件夹
code/part_2/outcome_for_part2/SDCH_20240203_0071_middle.back1
code/part_2/outcome_for_part2/SDCK_20240203_0071_middle.back1
'''
...
if __name__=='__main__':
    ...
    wavelength_id, spectrum_id, var_id=process_data(wavelength,spectrum,var,'code/part_2/outcome_for_part2/SDCK_20240203_0071_middle.back1',record_path)
    wavelength_id, spectrum_id, var_id=sort(wavelength_id, spectrum_id, var_id)

    make_csv('code/part_2/outcome_for_part2/SDCK_20240203_0071_middle.back1/outcome.csv', wavelength_id, spectrum_id, var_id)